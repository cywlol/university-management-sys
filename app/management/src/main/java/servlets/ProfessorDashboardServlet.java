...
// This is an endpoint for the professor to view the dashboard
...
public class ProfessorDashboardServlet extends HttpServlet {
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            // Select all the courses that the professor is teaching
            ...
            // Create a list of courses that the professor is teaching to be displayed on the dashboard
            ...
            // Set attributes in request, send to frontend
